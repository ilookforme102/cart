                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            <a class="navbar-brand" href="#">Welcome Fake Zalando</a>
                        </div>
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="#">Home</a></li>
                            <li><a href="#" onclick="window.location = 'shopping/document_view'">Doument</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
            <div id = "heading">
                <h2 align="center">View and take the items you want!</h2>
            </div>
                <div id="text"> 
            ...
            foreach ($products as $product) {
                ...
                <div id='product_div'>  
                    ...
                    <div id='info_product'>
                        ...
                        <div id='rs'><b>Price</b>:<b style="color:green">
                            $<?php echo $price; ?></b></div>
                        <?php
